...
const TONES = [
  ...
  { value: "provocative", label: "Provocative", desc: "Bold, attention-grabbing" },
      ...
      <div className="mt-6 flex w-full max-w-lg items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {step < 3 && (
            <button
              onClick={next}
              className="flex items-center gap-1 rounded-xl bg-[#7C3AED] px-5 py-2.5 text-sm font-semibold text-white transition-all hover:bg-[#6D28D9] hover:shadow-md"
            >
              Continue
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex-1">
          ...
          <input
            ...
            className="w-full rounded-lg border border-zinc-200 bg-white px-3 py-2 text-sm text-zinc-900 outline-none transition-all focus:border-[#7C3AED] focus:ring-2 focus:ring-[#7C3AED]/20"
            placeholder="https://..."
          />
        </div>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-xl border border-zinc-200 bg-white pl-8 pr-4 py-3 text-sm text-zinc-900 outline-none transition-all focus:border-[#7C3AED] focus:ring-2 focus:ring-[#7C3AED]/20"
    ...
    <div className="text-center py-4">
      ...
      <div className="space-y-3">
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#7C3AED] px-6 py-3.5 text-sm font-semibold text-white transition-all hover:bg-[#6D28D9] hover:shadow-md"
        >
          <Sparkles size={16} />
          Give me ideas
        </button>
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-xl border border-zinc-200 bg-white px-6 py-3.5 text-sm font-semibold text-zinc-700 transition-all hover:bg-zinc-50 hover:border-zinc-300"
        >
          <LinkIcon size={16} />
          I have a link
        </button>
