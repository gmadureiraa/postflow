// ──────────────────────────────────────────────────────────────────
// LEGADO v1 — página original de criação antes da unificação
// (commit 19d2e9f substituiu por um redirect). Mantida aqui só como
// referência da estrutura antiga (form "Nº de slides" + "CTA final"
// + preview ao vivo). NÃO está linkada no sidebar e NÃO faz parte do
// fluxo ativo. Fluxo atual: /app/create/new → /[id]/concepts →
// /[id]/templates → /[id]/edit → /[id]/preview.
// ──────────────────────────────────────────────────────────────────
